...
Am Arbeitspunkt $(\bm{x}^*, \bm{u}^*)$ gilt 
% f(x*,u*) = 0 => q'' = q' = 0 => h(x*,u*) = 0
\begin{align*}
    \bm{0} 
    = f(\bm{x}^*, \bm{u}^*)
    = \begin{bmatrix}
    ...
    \end{bmatrix}
    \Rightarrow
    \ddot{\bm{q}} = \dot{\bm{q}} = \bm{0}
    \Rightarrow
    h(\bm{x}^*, \bm{u}^*) = \bm{0}
\end{align*}

Für die Ableitung von $h$ in $(\bm{x}^*, \bm{u}^*)$ erhalten wir:
...
\begin{align*}
    ...
    \begin{bmatrix}
        ...
        \frac{\partial h_1}{\partial x_4} 
        & \frac{\partial h_2}{\partial x_4}
    \end{bmatrix}
    =
    \begin{bmatrix}
        \frac{\partial G_1}{\partial q_1} & \frac{\partial G_2}{\partial q_1} \\
        \frac{\partial G_1}{\partial q_2} & \frac{\partial G_2}{\partial q_2} \\
        -C_{11} & -C_{12} \\
        -C_{21} & -C_{22}
    \end{bmatrix}
    (\bm{x}^*, \bm{u}^*)
...
\begin{align*}
    ...
    &=  
    \begin{bmatrix}
        \frac{\partial \dot{q}_1}{\partial q_1}
        & \frac{\partial \dot{q}_1}{\partial q_2}
        & \frac{\partial \dot{q}_1}{\partial \dot{q_1}}
        & \frac{\partial \dot{q}_1}{\partial \dot{q_2}}
        \\
        \frac{\partial \dot{q}_2}{\partial q_1}
        & \frac{\partial \dot{q}_2}{\partial q_2}
        & \frac{\partial \dot{q}_2}{\partial \dot{q _1}}
        & \frac{\partial \dot{q}_2}{\partial \dot{q_2}}
        \\
        \frac{(M^-1)_{11} h_1 + (M^{-1})_{12} h_2}{\partial q_1}
        & \frac{(M^-1)_{11} h_1 + (M^{-1})_{12} h_2}{\partial q_2}
        & \frac{(M^-1)_{11} h_1 + (M^{-1})_{12} h_2}{\partial \dot{q_1}}
        & \frac{(M^-1)_{11} h_1 + (M^{-1})_{12} h_2}{\partial \dot{q_2}}
        \\
        \frac{(M^{-1})_{21} h_1 + (M^{-1})_{22} h_2}{\partial q_1}
        & \frac{(M^{-1})_{21} h_1 + (M^{-1})_{22} h_2}{\partial q_2}
        & \frac{(M^{-1})_{21} h_1 + (M^{-1})_{22} h_2}{\partial \dot{q_1}}
        & \frac{(M^{-1})_{21} h_1 + (M^{-1})_{22} h_2}{\partial \dot{q_2}}
    \end{bmatrix}
    (\bm{x}^*, \bm{u}^*) \\
    &=
    \begin{bmatrix}
...
%----------------------------------------------------------------------------------------------
\begin{satz}
    Wir erhalten die Struktur der Ableitungen konkret fest:
    \begin{align*}
        A &=
        \begin{bmatrix}
            0 & 1 \\
            M^{-1} \left( -\frac{\partial G}{\partial \bm{q}} \right) & 0
        \end{bmatrix}, \quad
        B =
        \begin{bmatrix}
            0 \\
        ...
        h_{\bm{x}} =
        \begin{bmatrix}
        - \frac{\partial C}{\partial \bm{q}} \dot{\bm{q}} - \frac{\partial G}{\partial \bm{q}}
        \\
        - C(\bm{x}^*) - \frac{\partial C}{\partial \dot{\bm{q}}} \dot{\bm{q}}
        \end{bmatrix}
        =
        \begin{bmatrix}
            - \frac{\partial G}{\partial \bm{q}}(\bm{x}^*)
            \\
            - C(\bm{x}^*)
        \end{bmatrix}
    \end{align*}
